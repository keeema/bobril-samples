...
export const mainPage = b.createComponent({
  render(_ctx: b.IBobrilCtx, me: b.IBobrilNode): void {
    me.children = [
      ...
      tag(
        "p",
        f("{arg, number, custom, format:{{myFormat}}}", {
          arg: 1.234,
          myFormat: "0.00000"
        })
      ),
      ...
      tag(
        "p",
        f("{a, date, custom, format:{{myFormat}} }", {
          a: new Date(2000, 0, 2),
          myFormat: "ddd"
        })
      ),
      ...
      tag(
        "p",
        f("{a, time, calendar}", { a: Date.now() + 2 * 24 * 60 * 60 * 1000 })
      ),
      tag(
        "p",
        f("{a, time, calendar}", { a: Date.now() + 7 * 24 * 60 * 60 * 1000 })
      ),
